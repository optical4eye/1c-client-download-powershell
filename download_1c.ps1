...
#download files
Invoke-WebRequest -Uri $download_url_thin -WebSession $fb -OutFile "$thin_client_file"
Invoke-WebRequest -Uri $download_url_full -WebSession $fb -OutFile "$full_client_file"
